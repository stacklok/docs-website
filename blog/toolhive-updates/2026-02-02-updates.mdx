...
**The [MCPServer CRD](/toolhive/reference/crds/mcpserver)** now supports custom
certificate authorities, enabling ToolHive to validate OAuth tokens issued by
private on-premises identity provider instances, essential for organizations
with internal PKI infrastructure.
