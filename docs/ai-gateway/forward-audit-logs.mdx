...
sampling, on the principle that routing and volume control belong to your ingest
layer rather than to the thing being audited.
...
request, configured under `spec.journaling`. Audit events record _that_ a
request was admitted, denied, or masked and _why_; journaling records _what_ the
prompt and response contained.
