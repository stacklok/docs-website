...
always means the audience configured on the gateway and on the budget service
...
- [Budgets in the console](../enterprise-console/admin/budgets.mdx) for the
  same operations without the API.
