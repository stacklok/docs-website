...
[Registry Server](../../toolhive/guides-registry/index.mdx). It provides skills
discovery and installation, one-click Stacklok Desktop integration, and full
catalog management for platform teams. Use it to:
