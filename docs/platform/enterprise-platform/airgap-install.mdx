...
If the transfer workstation needs the CLI plugin itself, mirror the
`preflight_<os>_<arch>.tar.gz` release asset from
...
[Step 1](#step-1-get-your-license-and-image-list).
