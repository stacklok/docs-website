...
| [The console](./enterprise-console/index.mdx) (administration and end-user surfaces) |     —     |     ✓      |
| [Stacklok CLI](./enterprise-cli/index.mdx) (centrally enforced client policy)        |     —     |     ✓      |
...
### Connector Gateway: Tool catalog and connection governance
...
### Console: Self-service with guardrails
