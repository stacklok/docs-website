...
| :------------------------------- | :----------------------------------------------------------------------------------------------------------------------------------------------------- | :---------------------------------: |
| **Stacklok Enterprise Platform** | Enterprise licensed distribution of ToolHive with the AI Gateway, the MCP gateway, the console, IdP integration, policy engine, and SLA-backed support |         Annual subscription         |
