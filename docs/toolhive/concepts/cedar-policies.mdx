...
Not all MCP servers set all annotation fields. If an annotation is absent, the
attribute does not exist on the resource entity. Accessing a missing attribute
causes a Cedar evaluation error, which ToolHive treats as a deny.
