...
description:
  Tool filtering and overrides reduce context window pollution and improve AI
...
- [Customize tools (CLI)](../guides-cli/configure-mcp-servers.mdx#run-a-server-exposing-only-selected-tools)
- [Customize tools (UI)](../guides-ui/customize-tools.mdx)
- [Customize tools (Kubernetes)](../guides-k8s/customize-tools.mdx)
- [MCPToolConfig CRD reference](../reference/crds/index.mdx)
