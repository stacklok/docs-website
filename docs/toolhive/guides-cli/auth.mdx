...
- [Cedar policies](../concepts/cedar-policies.mdx) for policy patterns and
  examples
- [Authorization policy reference](../reference/authz-policy-reference.mdx) for
  the complete dictionary of entity types, actions, and attributes
- [Cedar documentation](https://docs.cedarpolicy.com/) for the Cedar policy
