...
![Latest version](https://img.shields.io/github/v/release/stacklok/toolhive?style=for-the-badge&label=Latest%20version&color=b2e4bc)
![Release date](https://img.shields.io/github/release-date/stacklok/toolhive?display_date=published_at&style=for-the-badge&label=Released&color=b2e4bc)
