...
<ThemedImage
  alt='ToolHive Cloud UI showing the browsable catalog of MCP servers'
  sources={{
    light: useBaseUrl('/img/toolhive/cloud-ui-light.webp'),
    dark: useBaseUrl('/img/toolhive/cloud-ui-dark.webp'),
  }}
  title='ToolHive Cloud UI catalog'
/>
<br />
...
Stacklok Enterprise includes an enhanced Cloud UI that builds on the open source
catalog with full management capabilities. Browse and install skills, and manage
registry sources and entries directly from the web interface.
