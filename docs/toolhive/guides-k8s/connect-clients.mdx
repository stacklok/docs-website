...
description:
  Connect AI clients to Kubernetes-hosted MCP servers managed by the ToolHive
  operator.
---
...
[ToolHive CLI guide](../guides-cli/run-remote-mcp-servers.mdx#authentication-setup)
for details.
...
- [Run remote MCP servers (CLI)](../guides-cli/run-remote-mcp-servers.mdx)
...
- [Kubernetes CRD reference](../reference/crds/mcpserver.mdx) - Full MCPServer
  specification
