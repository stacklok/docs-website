...
`telemetryConfig`) were deprecated in v0.17.0 and **removed in v0.18.0**. If you
are migrating across multiple versions, skip directly to the
[`configYAML` format required in v0.18.0](#mcpregistry-legacy-fields-removed).
