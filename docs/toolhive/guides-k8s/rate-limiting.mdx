...
title: Rate limiting
description:
  How to configure per-user and shared rate limits on MCPServer resources to
  prevent noisy neighbors and protect downstream services.
---
...
- [Authentication and authorization](./auth-k8s.mdx) to enable per-user
  identification
