...
Available principal attributes depend on the claims in your JWT tokens. Common
claims include:
...
- `mcp_tools_list_total` - Tools list operations
- `mcp_tools_call_total` - Tool call operations
- `auth_validation_total` - Token validations
- `auth_validation_failures_total` - Failed token validations
