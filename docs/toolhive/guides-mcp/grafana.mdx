...
In the **Secrets** section, add your Grafana service account token to
authenticate with the Grafana API. Create a service account in Grafana with the
necessary permissions for the tools you plan to use. Refer to the
[Grafana service account documentation](https://grafana.com/docs/grafana/latest/administration/service-accounts/)
for details on creating tokens.
...
Create a secret containing your Grafana service account token. Follow the
[Grafana service account documentation](https://grafana.com/docs/grafana/latest/administration/service-accounts/)
to create a token with appropriate permissions:
