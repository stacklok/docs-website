...
This is a remote MCP server that uses OAuth authentication with auto-discovered
settings, meaning ToolHive handles all authentication setup automatically with
...
spec:
  image: ghcr.io/stacklok/dockyard/npx/notion:2.0.0
  transport: stdio
  port: 8080
  permissionProfile:
    type: builtin
