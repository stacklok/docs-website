...
### Plugins extension API (`/x/dev.toolhive/plugins`)

| Event type             | Trigger                           |
| ---------------------- | --------------------------------- |
| `plugin.list`          | Plugin list requested             |
| `plugin.read`          | Plugin retrieved                  |
| `plugin.versions.list` | Plugin version list requested     |
| `plugin.version.read`  | Specific plugin version retrieved |
