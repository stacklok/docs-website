...
repository, see [Publish MCP servers](./publishing.mdx).
...
See [Publish MCP servers](./publishing.mdx) for request examples covering
...
- [Publish MCP servers](./publishing.mdx) to a Git, file, or managed source
