...
For most users, deploying with the [ToolHive Operator](./deploy-operator.mdx) is
simpler and recommended. Use manual deployment for advanced use cases or
environments where the operator is not available.
