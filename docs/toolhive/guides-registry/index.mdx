...
description:
  Deploy, configure, and secure the ToolHive Registry Server for MCP server,
...
servers, skills, and plugins for your team. Use it when you want a trusted
catalog that aggregates entries from Kubernetes clusters, Git repositories, API
endpoints, and local files behind a standard MCP Registry API.
