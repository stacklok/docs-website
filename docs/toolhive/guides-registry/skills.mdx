...
[Publish MCP servers](./publishing.mdx#registry-file-format) for the file
...
Version comparison and the `latest` pointer behave the same as for servers. See
[Versioning behavior](./publishing.mdx#versioning-behavior) in the publishing
guide.
