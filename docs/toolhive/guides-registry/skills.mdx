...
title: Manage skills
description:
  Publish, list, retrieve, and delete skills in the ToolHive Registry Server
...
be a subset of your JWT claims. All subsequent versions of the same skill must
...
- [Understanding skills](../concepts/skills.mdx) - background on the skills
  model
- [Install skills with the CLI](../guides-cli/skills-management.mdx) - install
