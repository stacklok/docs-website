...
description:
  Install the ToolHive desktop app on macOS, Windows, or Linux for graphical MCP
  server management.
---
...
![Latest version](https://img.shields.io/github/v/release/stacklok/toolhive-studio?style=for-the-badge&label=Latest%20version&color=bddfc2)
![Release date](https://img.shields.io/github/release-date/stacklok/toolhive-studio?display_date=published_at&style=for-the-badge&label=Released&color=bddfc2)
