...
page header. Click it to pull the latest registry metadata and server list
without restarting ToolHive or reopening the page. The button is hidden for the
built-in registry.
