...
whenever it consumes it. Move the value to
`spec.authServerConfig.primaryUpstreamProvider` to clear the warning; the
deprecated field is planned for removal one release after the deprecation cycle.
