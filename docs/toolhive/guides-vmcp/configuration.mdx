...
[MCPGroup](../reference/crd-spec.mdx#apiv1alpha1mcpgroup) to organize the
backend MCP servers. An MCPGroup is a logical container that groups related
MCPServer and MCPRemoteProxy resources together.
