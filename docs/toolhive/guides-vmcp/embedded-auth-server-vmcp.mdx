...
For why delegation exists and how to authorize an external actor to use a
delegate client, see
[Delegate clients and RFC 8693 delegation](../concepts/embedded-auth-server.mdx#minting-delegated-tokens-with-delegate-clients).
