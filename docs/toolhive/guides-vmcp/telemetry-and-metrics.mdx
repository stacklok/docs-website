...
When you update the MCPTelemetryConfig resource, the operator automatically
detects the change via `TelemetryConfigHash` in the status and triggers a
rolling update of affected VirtualMCPServer deployments.
