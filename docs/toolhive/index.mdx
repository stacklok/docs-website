...
- [**ToolHive Cloud UI**](./guides-cloud-ui/index.mdx) is a web-based catalog
  frontend for the Registry Server. It gives your team a browsable interface to
  discover MCP servers and copy connection URLs, secured with your own OIDC
  provider.
...
available as a cross-platform desktop app (the ToolHive UI) and a web-based
frontend (the [Cloud UI](./guides-cloud-ui/index.mdx)) to the ToolHive Registry
Server.
...
- Cross-platform [desktop app](https://github.com/stacklok/toolhive-studio) and
  browser-based [Cloud UI](./guides-cloud-ui/index.mdx)
