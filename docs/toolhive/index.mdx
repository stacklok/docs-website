...
<ThemedImage
  ...
  sources={{
    light: useBaseUrl('/img/logos/toolhive-default-black.svg'),
    dark: useBaseUrl('/img/logos/toolhive-default-white.svg'),
  }}
  title='ToolHive logo'
  height={'80'}
/>
...
<ThemedImage
  alt='ToolHive symbol'
  sources={{
    light: useBaseUrl('/img/logos/toolhive-symbol-dark-green.svg'),
    dark: useBaseUrl('/img/logos/toolhive-symbol-light-green.svg'),
  }}
