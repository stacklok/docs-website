...
identity provider integrations (Okta, Entra ID), hardened images,
[a web console](../platform/enterprise-console/index.mdx) for spend, budgets,
connectors, and usage, and platform capabilities for teams running MCP in
production.
