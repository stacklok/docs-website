...
description:
  Collect metrics and traces for MCP workloads using OpenTelemetry, Jaeger, and
  Prometheus with the CLI or Kubernetes operator.
...
- Completed the [ToolHive CLI quickstart](../guides-cli/quickstart.mdx)
...
- Completed the [ToolHive Kubernetes quickstart](../guides-k8s/quickstart.mdx)
...
- A [supported MCP client](../reference/client-compatibility.mdx) for testing
- The [ToolHive CLI](../guides-cli/quickstart.mdx) (optional, for client
  configuration)
...
If you've completed the [Kubernetes quickstart](../guides-k8s/quickstart.mdx),
...
- **Secrets integration**: Learn about
  [HashiCorp Vault integration](./vault.mdx)
