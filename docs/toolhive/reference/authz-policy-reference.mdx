...
This page is the complete reference for everything you can use when writing
authorization policies for ToolHive MCP servers. It covers Cedar entity types,
actions, resource attributes, tool annotations, group membership, and the HTTP
PDP model for external policy decision points.
