...
description:
  Supported AI clients and their transport, authentication, and feature
  compatibility with ToolHive.
---
...
[Qoder IDE](https://qoder.com/) stores its MCP configuration in a JSON file in
your home directory.
...
When you register Qoder as a client, ToolHive automatically updates this file
whenever you run an MCP server. Skills are installed under `~/.qoder/skills/`
(user scope) or `<PROJECT_ROOT>/.qoder/skills/` (project scope).
