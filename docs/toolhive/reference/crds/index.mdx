...
<DocCard
  item={{
    type: 'link',
    href: '/toolhive/reference/crds/mcpauthzconfig',
    label: 'MCPAuthzConfig',
    description: 'Resources are namespace-scoped and can only be referenced by MCPServer, MCPRemoteProxy...',
  }}
/>
