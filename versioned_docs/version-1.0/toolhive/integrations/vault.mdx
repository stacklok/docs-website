...
[vault-hardening]: https://developer.hashicorp.com/vault/tutorials/operations/production-hardening
[vault-injector]: https://developer.hashicorp.com/vault/docs/platform/k8s/injector
