...
- Try the [Playground](./playground.mdx) to test your optimized tool set
- [Organize MCP servers into groups](./group-management.mdx) to control which
  servers the optimizer includes
